...
import businessRatingsData from "../data/ratings-negocios.json";
import BusinessRatings from "../components/business_ratings";
  ...
  return (
    <div className="min-h-screen bg-green-50">
      ...
      <section className="bg-white py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Explora <span className="text-green-500">San Luis</span>
          </h2>
          <Map />
        </div>
      </section>
      ...
      <section className="py-20 bg-green-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <BusinessRatings
                businessName={businessRatingsData.businessName}
                averageRating={businessRatingsData.averageRating}
                totalReviews={businessRatingsData.totalReviews}
                comments={businessRatingsData.comments}
              />
            </div>
          </div>
        </div>
